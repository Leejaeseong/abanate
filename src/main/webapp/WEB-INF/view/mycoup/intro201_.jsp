    ...
    <div class="row wow fadeIn border border-dark justify-content-center">
      ...
      <div class="row w-100">
      	<h5 class="mt-3 ml-3 mr-3 mb-3">
        	<span class="text-primary font-weight-bold">○ Easy user registration ○</span>
        	
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	It’s really easy.
→[Membership Classification] You can leave it as a user.

→[Phone number] Please enter your phone number

→[Password] Please enter your own password with at least 6 characters

→[Confirm password] Enter the same information as the password

→[Name or Name] or the name
Please enter your nickname to use in the store.
