    ...
    <div class="row wow fadeIn border border-dark justify-content-center">
      ...
      <div class="row w-100">
      	<h5 class="mt-3 ml-3 mr-3 mb-3">
        	<span class="text-primary font-weight-bold">○ 우리 점포 정보 변경하기 ○</span>
        	...
        	<br/>
        	<br/> 상호를 변경할 수 있어요.
        	<br/> 하지만 고객이 친숙한 상호가 바뀌면
        	<br/> 혼란스러울 수 있으니
        	<br/> 되도록이면 유지할 것을 권고드려요
        	<br/> 
        	<br/> 점포 전화번호를 변경할 수 있어요.
        	<br/> 하지만 고객이 친숙한 연락처가 바뀌면
        	<br/> 혼란스러울 수 있으니
        	<br/> 되도록이면 유지할 것을 권고드려요
        	<br/> 
        	<br/> 점포 주소가 변경된 경우
