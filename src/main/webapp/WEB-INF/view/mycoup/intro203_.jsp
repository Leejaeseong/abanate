...
<body>
  ...
  <main>
    ...
    <div class="container bg-primary">
      <h1>        
        <span class="badge w-100 mb-2 mt-2" style="height:1.5em;"><i class="fas fa-info-circle"></i> Check around me</span>        
      </h1>
    </div>
    ...
    <div class="row wow fadeIn border border-dark justify-content-center">
      ...
      <div class="row w-100">
      	<h5 class="mt-3 ml-3 mr-3 mb-3">
        	<span class="text-primary font-weight-bold">○ Check coupons/points around me ○</span>
        	
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	Store where you can earn and use my location and coupons/points
Can you check on the map
        	
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	Touch (select) the store
...
You can see the date of visitor and earning/usage.
        	...
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	Good stores around me
Please use it a lot~^o^~
		</h5>
