...
<body>
  ...
  <main>
    ...
    <div class="container bg-primary">
      <h1>        
        <span class="badge w-100 mb-2 mt-2" style="height:1.5em;"><i class="fas fa-info-circle"></i> Change phone number</span>        
      </h1>
    </div>
    ...
    <div class="row wow fadeIn border border-dark justify-content-center">
      ...
      <div class="row w-100">
      	<h5 class="mt-3 ml-3 mr-3 mb-3">
        	<span class="text-primary font-weight-bold">○ Change my phone number ○</span>
        	
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	My phone number has changed
When you want to move coupons and points
Enter the number to move
After confirming the name of the member who appeared
If you enter the password correctly
Phone number transfer is completed easily.
        	
        	<br/><br/>
        	<span class="text-success font-weight-bold">⊙</span>
        	After moving, you will no longer use your old phone number.
		</h5>
