    ...
    <div class="container">
      ...
      <div class="row wow fadeIn border border-dark justify-content-center">
        ...
        <div id="divStorNmForm" class="col form-inline text-center">
          <input type="text" class="form-control form-control-sm" name="storNm" aria-describedby="stor name" placeholder="상호" style="width:12em;" maxlength="32" value="${sessionScope.cmStor.storNm}">
        </div>
        ...
        <div id="divStorAddrForm" class="col form-inline text-center">
          	<input type="text" class="form-control form-control-sm" id="addrPt1" name="addrPt1" aria-describedby="address" placeholder="주소" style="width:12em;" maxlength="85" value="${sessionScope.cmStor.addrPt1}">
          	<div class="w-100" style="height:1px;">&nbsp;</div> <!-- space br -->
          	<div onclick="popAddress();">위도</div><input type="text" class="form-control form-control-sm" id="mapLat" name="mapLat" style="width: 3.5em;" value="${sessionScope.cmStor.mapLat}"/>          	       
          	<div onclick="popAddress();">경도</div><input type="text" class="form-control form-control-sm" id="mapLng" name="mapLng" style="width: 3.5em;" value="${sessionScope.cmStor.mapLng}"/>
        </div>
