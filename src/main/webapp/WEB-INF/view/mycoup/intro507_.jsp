...
<body>
  ...
  <main>
    ...
    <div class="container bg-primary">
      <h1>        
        <span class="badge w-100 mb-2 mt-2" style="height:1.5em;"><i class="fas fa-info-circle"></i> Logout</span>        
      </h1>
    </div>
    ...
    <div class="row wow fadeIn border border-dark justify-content-center">
      ...
      <div class="row w-100">
      	<h5 class="mt-3 ml-3 mr-3 mb-3">
        	<span class="text-primary font-weight-bold">○ Log out ○</span>
        
         <br/><br/>
         <span class="text-success font-weight-bold">⊙</span>
         Wait for another phone or a shared PC
         <br/> While using this site
         <br/> To stop safely
         <br/> Please log out.
         <br/>
         <br/> Exploitation from others
         <br/> You can prevent it~
		</h5>
